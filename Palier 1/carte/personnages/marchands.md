...
<h2 align="center">🛡️ Marchands d'Équipements</h2>
...
<h2 align="center">💍 Marchands d'Accessoires</h2>

{% tabs %}
{% tab title="Vallhat" %}
{% hint style="info" %}
Coordonnées (485,3058)
{% endhint %}

|                                                                                                             Équipement | Prix Achat                                      |
| ---------------------------------------------------------------------------------------------------------------------: | ----------------------------------------------- |
|         🧪 [<mark style="color:$success;">Bague Gluante</mark>](../../equipement/accessoires/anneaux.md#bague-gluante) | 🪙<mark style="color:yellow;">Cols</mark> 1,000 |
| 🧪 [<mark style="color:$success;">Amulette Gluante</mark>](../../equipement/accessoires/amulettes.md#amulette-gluante) | 🪙<mark style="color:yellow;">Cols</mark> 1,000 |
{% endtab %}

{% tab title="Tolbana" %}
{% hint style="info" %}
Coordonnées (3320,1605)
{% endhint %}

|                                                                                                               Équipement | Prix Achat                                      |
| -----------------------------------------------------------------------------------------------------------------------: | ----------------------------------------------- |
|    💀 [<mark style="color:$info;">Bague de Squelette</mark>](../../equipement/accessoires/anneaux.md#bague-de-squelette) | 🪙<mark style="color:yellow;">Cols</mark> 1,000 |
| 🦌 [<mark style="color:orange;">Bracelet des Cerfs</mark>](../../equipement/accessoires/bracelets.md#bracelet-des-cerfs) | 🪙<mark style="color:yellow;">Cols</mark> 2,500 |
{% endtab %}
{% endtabs %}

<h2 align="center">🫙 Marchands de Consommables</h2>
...
|                                                      Équipement | Prix Achat                                      |
| --------------------------------------------------------------: | ----------------------------------------------- |
|          🫙 <mark style="color:$danger;">Potion de Vie I</mark> | 🪙<mark style="color:yellow;">Cols</mark> 20    |
|         🫙 <mark style="color:$danger;">Potion de Vie II</mark> | 🪙<mark style="color:yellow;">Cols</mark> 40    |
|           🫙 <mark style="color:blue;">Potion de Mana I</mark>  | 🪙<mark style="color:yellow;">Cols</mark> 20    |
...
<h2 align="center">⛏️ Marchands d'Outils</h2>

{% tabs %}
{% tab title="Ville de Départ" %}
{% hint style="info" %}
Coordonnées (1813,4162)
{% endhint %}

|                                                     Outil | Prix Achat                                   | Prix Revente                                |
| --------------------------------------------------------: | -------------------------------------------- | ------------------------------------------- |
|        ⛏️ <mark style="color:$info;">Pioches Fêlée</mark> | 🪙<mark style="color:yellow;">Cols</mark> 20 | 🪙<mark style="color:yellow;">Cols</mark> 4 |
|         🪓 <mark style="color:red;">Hache Ébréchée</mark> | 🪙<mark style="color:yellow;">Cols</mark> 20 | 🪙<mark style="color:yellow;">Cols</mark> 4 |
|      🪒 <mark style="color:$warning;">Serpe Tordue</mark> | 🪙<mark style="color:yellow;">Cols</mark> 20 | 🪙<mark style="color:yellow;">Cols</mark> 4 |
| 🎣 <mark style="color:blue;">Canne à Pêche en Bois</mark> | 🪙<mark style="color:yellow;">Cols</mark> 20 | 🪙<mark style="color:yellow;">Cols</mark> 4 |
{% endtab %}

{% tab title="Virelune" %}
{% hint style="info" %}
Coordonnées (1587,1985)
{% endhint %}
