...
{% tabs %}
{% tab title="Amulette de Cuivre" %}
> _"Une amulette taillé dans un fer simple, lourde et marqué par l'usure du temps"_
...
> _"Sculptée dans un bois ancien et renforcée par des pierres magiques, elle semble en harmonies avec le marécage"_
...
> _"Orné de crocs massifs, arraché au loup alpha Albal, prédateur dominant de la vallée des loups"_
