---
description: Coordonnées (-159,10)
---
...
{% hint style="info" %}
Aidez Havca cuisiner un ragoût parfumé (-159,10)
{% endhint %}

#### Objet Demandé

* 🍄 <mark style="color:orange;">Champignono</mark> 1
* 🌿 <mark style="color:$success;">Herbe Parfumée</mark> 2

{% hint style="info" %}
Le Champignono se trouve en (-116,-104)

Les Herbes Parfumées se trouvent en (453,-712)
{% endhint %}
